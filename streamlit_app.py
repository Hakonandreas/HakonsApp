...
# -----------------------
# Define navigation with st_pages
# -----------------------
show_pages(
    [
        # -----------------------
        ...
        Page("Pages/Elhub Production Overview.py", "Elhub Production Overview", "⚡"),
        Page("Pages/Weather Data Explorer.py", "Weather Data Explorer", "🌦️"),

        # -----------------------
        Section("Analysis Tools", icon="🛠️"),
        # -----------------------
        Page("Pages/STL and Spectrogram Analysis.py", "STL & Spectrogram Analysis", "📈"),
        Page("Pages/Outlier and Anomali Detection.py", "Outlier & Anomaly Detection", "🔍"),
        Page("Pages/SWC Meteorology and Energy.py", "SWC Meteorology & Energy", "🌡️"),

        # -----------------------
        Section("Mapping & Environment", icon="🗺️"),
        # -----------------------
        Page("Pages/Energy Map & Snow Drift Explorer.py", "Energy Map & Snow Drift Explorer", "❄️"),

        # -----------------------
        Section("Forecasting", icon="📉"),
        # -----------------------
        Page("Pages/Forecasting.py", "Forecasting", "🔮"),
    ]
)
